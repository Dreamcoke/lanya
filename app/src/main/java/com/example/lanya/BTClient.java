...
public class BTClient extends Activity {
	...
	private TextView hu;       //接收数据显示句柄
	private TextView te;       //接收数据显示句柄
	private TextView time;       //接收数据的时间显示句柄
	private ScrollView sv;      //翻页句柄
	private String[] data;    //显示用数据缓存
	private String fmsg = "";    //保存用数据缓存
	private String smsg = "";    //保存用数据缓存
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		te = (TextView) findViewById(R.id.textView4);      //得到数据显示句柄
		hu = (TextView) findViewById(R.id.textView6);      //得到数据显示句柄
...
//							if(Double.parseDouble(data[1])>40.0)
//							{
//								try {
//									email.init("您的温度为"+data[1]+" 请及时查看!");
//								}
//								catch (Exception e){
//
//								}
//							}
	...
	Handler handler= new Handler(){
		public void handleMessage(Message msg){
			...
			te.setText(data[1]+"%");   //显示数据
			hu.setText(data[0]+"°C");   //显示数据
			time.setText(data[2]);
